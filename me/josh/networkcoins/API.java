...
public class API {
	...
	public static Integer getCoinsOffline(OfflinePlayer p) {
		try {
			Connection c = NetworkCoins.getConnection();
			String uuid = p.getUniqueId().toString();
			Statement check = c.createStatement();
	...
	public static void addCoinsOffline(OfflinePlayer p, Integer i) {
		try {
			Connection c = NetworkCoins.getConnection();
			String uuid = p.getUniqueId().toString();
			Statement check = c.createStatement();
	...
	public static void takeCoins(Player p, Integer i) {
		try {
			Connection c = NetworkCoins.getConnection();
			String uuid = p.getUniqueId().toString();
			Statement check = c.createStatement();
	...
	public static void takeCoinsOffline(OfflinePlayer p, Integer i) {
		try {
			Connection c = NetworkCoins.getConnection();
			String uuid = p.getUniqueId().toString();
			Statement check = c.createStatement();
